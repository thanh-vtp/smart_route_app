...
import 'package:smart_route_app/core/common/presentation/widgets/recent_search_widget.dart';
...
class _SearchDirectionsPageState extends ConsumerState<SearchDirectionsPage> {
  ...
  Future<void> _openMapPicker() async {
    ...
    if (widget.fieldType == LocationFieldType.start &&
      ...
      initialLat = widget.currentEnd!.lat;
      initialLon = widget.currentEnd!.lng;
    } else if (widget.fieldType == LocationFieldType.end &&
        widget.currentStart != null) {
      initialLat = widget.currentStart!.lat;
      initialLon = widget.currentStart!.lng;
    } else {
