...
import 'package:smart_route_app/core/common/presentation/providers/states/geocode_address_state.dart';
  ...
  Widget _buildAddressSubtitle(AddressResult result) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Lat: ${result.lat.toStringAsFixed(4)}, Lon: ${result.lng.toStringAsFixed(4)}',
