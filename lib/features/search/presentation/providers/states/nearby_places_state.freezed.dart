...
mixin _$NearbyPlacesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            ...
            List<NearbyPlace> filteredPlaces,
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function()? initial,
    TResult Function()? loading,
    TResult Function(List<NearbyPlace> places, List<NearbyPlace> filteredPlaces,
            EmergencyCategory? selectedCategory)?
        loaded,
    TResult Function(Failure failure)? error,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      ...
      required final List<NearbyPlace> filteredPlaces,
  ...
  final List<NearbyPlace> _filteredPlaces;
  @override
  ...
  @override
  String toString() {
    return 'NearbyPlacesState.loaded(places: $places, filteredPlaces: $filteredPlaces, selectedCategory: $selectedCategory)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(places, filteredPlaces, selectedCategory);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(places, filteredPlaces, selectedCategory);
  }
...
abstract class _Loaded implements NearbyPlacesState {
  const factory _Loaded(
      {required final List<NearbyPlace> places,
      required final List<NearbyPlace> filteredPlaces,
      required final EmergencyCategory? selectedCategory}) = _$LoadedImpl;

  List<NearbyPlace> get places;
  List<NearbyPlace> get filteredPlaces;
  EmergencyCategory? get selectedCategory;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'NearbyPlacesState.error(failure: $failure)';
  }
